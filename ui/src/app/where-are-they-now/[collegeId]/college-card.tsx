...
const CollegeCard = ({
  ...
  return (
    <div
      className="mb-8 flex flex-col items-center justify-center rounded-lg border border-gray-200 p-4"
      style={{
    ...
    >
      <div className="text-2xl font-bold">{`${college.name} ${college.mascot}`}</div>
